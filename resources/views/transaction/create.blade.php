        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 ">
                    <form action="{{ route('transactions.store') }}" method="post" class="max-w-screen-md">
                        @csrf
                        <div>
                        ...
                        <div class="mt-4">
                            ...
                            <select id="type"
                                ...
                                name="type" :value="old('type')" autofocus autocomplete="type">
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="spend_date" class="block mt-1 w-full" type="date" name="spend_date"
                                :value="old('spend_date')" autofocus autocomplete="spend_date" />
